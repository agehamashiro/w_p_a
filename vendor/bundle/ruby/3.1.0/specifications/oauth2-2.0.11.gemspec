...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://gitlab.com/oauth-xx/oauth2/-/issues", "changelog_uri" => "https://gitlab.com/oauth-xx/oauth2/-/blob/v2.0.11/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/oauth2/2.0.11", "funding_uri" => "https://liberapay.com/pboling", "homepage_uri" => "https://oauth2.galtzo.com/", "mailing_list_uri" => "https://groups.google.com/g/oauth-ruby", "news_uri" => "https://www.railsbling.com/tags/oauth2", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/oauth-xx/oauth2/releases/tag//v2.0.11", "wiki_uri" => "https://gitlab.com/oauth-xx/oauth2/-/wiki" } if s.respond_to? :metadata=
